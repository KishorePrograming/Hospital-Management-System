...
public class ViewDoctor extends javax.swing.JFrame {
    ...
    public ViewDoctor(int id, String username, String usertype,Connection con) {
        this.con=con;
        initComponents();
        this.id=id;
    ...
    private void initComponents() {
        ...
        jtbleChannel.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Channel No", "Doctor Name", "Specialazation", "Room No", "Channel Fee"
            }
        ) {
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(63, 63, 63)
                                .addComponent(btnPrescription, javax.swing.GroupLayout.PREFERRED_SIZE, 107, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void btnPrescriptionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrescriptionActionPerformed
       ...
       String docName = df.getValueAt(selectedIndex, 1).toString();
        ...
        this.setVisible(false);
        new Prescription(this.id,this.username,this.usertype,con,chNo,docName).setVisible(true);
       }else{
    ...
    private void jtbleChannelMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtbleChannelMousePressed
      if(0<=jtbleChannel.getSelectedRow()){
       ...
       String chNo = df.getValueAt(selectedIndex, 0).toString();
       if(!chNo.equals(null)&&!chNo.equals("")){
